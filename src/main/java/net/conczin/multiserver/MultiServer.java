...
public class MultiServer {
    ...
    public static void launchServer(String[] strings, String root, int port) {
        ...
        try {
            ...
            final DedicatedServer dedicatedServer = MinecraftServer.spin(thread -> {
                DedicatedServer server = new DedicatedServer(thread, levelStorageAccess, packRepository, worldStem, dedicatedServerSettings, DataFixers.getDataFixer(), services, LoggerChunkProgressListener::new);
                server.setPort(port);
